...
DEFAULT_CATALOG   = 'C:\\Users\\krish\\Documents\\Northeastern University\\Spring22\\DAMG 7245\\Assignment-3\\SEVIR API\\Working code\\CATALOG.csv'
DEFAULT_DATA_HOME = 'C:\\Users\\krish\\Documents\\Northeastern University\\Spring22\\DAMG 7245\\Assignment-3\\SEVIR API\\Working code\\sevir'
...
#        print(f'\n#####################\n {self.catalog.llcrnrlat} \n#####################\n')
        
    # helper function to output the _samples and catalogue files in intermediate stages
    def return_catalog(self):
        return self._samples
    
    # helper function to load a single sample rather than batches (inspired by __getitem__ function, but rewritten for single sample)
    def load_sample(self):
        batch = self._samples.iloc[0]
        data = {}
        data = self._read_data(batch,data)
